...
def check_state(placa):
    ...
    if letter_1_value == 0:
        state = "Paraná"
    elif letter_1_value == 1 and letter_2_value <=4 :
        state = "Paraná"
    #check GREMIO
    elif (letter_1_value == 8 or letter_1_value == 9) and letter_2_value>=4 and letter_3_value >=16:
        state = 'É O CARRO DO GREMIO'
    
    else:
        return "Carros desse estado não pode entrar no estacionamento"
    return state
